...
urlpatterns = [
    ...
    # path('Parents/pupils/',ParentPupilView.as_view(),name='parent-pupil-view')
    ...
    path('Parents/Not/Deleted/',views.ParentNotDeletedView.as_view(),name='parent-not-delted-view'),
    path('Parents/Deleted/',views.ParentDeletedView.as_view(),name='parent-not-delted-view'),
    path('Pupils/not-linked-to-class/',views.PupilsNotLinkedView.as_view(),name='not-linked-view'),
    path('Pupils/linked-to-class/',views.PupilsLinkedView.as_view(),name='not-linked-view'),
